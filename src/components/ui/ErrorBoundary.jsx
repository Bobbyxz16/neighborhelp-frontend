        ...
        <div className="min-h-screen flex items-center justify-center bg-neutral-50">
          <div className="text-center p-8 max-w-2xl w-full">
            ...
            <div className="flex flex-col gap-1 text-center">
              ...
              {this.state.error && (
                <div className="mt-4 text-left bg-white border rounded p-4 overflow-auto">
                  <div className="text-sm font-medium text-neutral-800 mb-1">Error:</div>
                  <pre className="text-xs text-neutral-700 whitespace-pre-wrap">{String(this.state.error?.message || this.state.error)}</pre>
                  {this.state.errorInfo?.componentStack && (
                    <>
                      <div className="text-sm font-medium text-neutral-800 mt-3 mb-1">Component Stack:</div>
                      <pre className="text-xs text-neutral-700 whitespace-pre-wrap">{this.state.errorInfo.componentStack}</pre>
                    </>
                  )}
                </div>
              )}
